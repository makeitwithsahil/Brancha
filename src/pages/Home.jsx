    ...
    <div className="bg-[#FAF9F7] overflow-hidden hw-accelerate">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <br />
              <span className="italic text-[#ff5849]" style={{ fontWeight: 500 }}>start growing consistently</span>
            </motion.h1>
            ...
            >
              <Link to="/contact" className="w-full sm:w-auto">
                <motion.button 
                  className="group relative w-full sm:w-auto px-7 sm:px-8 py-3.5 sm:py-4 text-sm sm:text-base font-medium text-white bg-gradient-to-br from-[#ff5343] to-[#ff5c49] rounded-full transition-all duration-400 shadow-lg shadow-[#e2493b]/20 flex items-center justify-center gap-2 hw-accelerate overflow-hidden" 
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
          ...
          <motion.div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6 md:gap-7" variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once: true, amount: 0.2 }}>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-[#FAF9F7]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
          ...
          <div className="mb-20 sm:mb-24">
            ...
            <motion.div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-6" variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once: true, amount: 0.2 }}>
